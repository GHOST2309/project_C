...
from random import choice # библиотека random для случайного выбора слова из списка

HANGMAN = (    #кортеж, в котором хранится изображение висельника)
    """
     ------
     |    |
     |
...
WORDS = ("турмалин", "лазурит", "изумруд")  # Слова для угадывания
...
while wrong < max_wrong and so_far != word: # прогон цикла с предусловием
    ...
    while guess in used: # еще один прогон
